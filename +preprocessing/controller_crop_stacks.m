function job_settings = controller_crop_stacks(job_settings, input_folder_name, output_folder_name)
    ...
    for i = 1:num_stacks
        ...
        % get crop coords:
        job_settings = preprocessing.algorithm_crop_stack(job_settings, paths, list_stacks, i);
