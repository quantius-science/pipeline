function [results_formatted, index] = algorithm_format_results_point(results_formatted, results_for_job, image_info, index)

    % get number of objects:
    num_objects = size(results_for_job.raw_data{1,1}, 2);
    ...
    for j = 1:num_objects
        ...
        results_for_object = results_for_job.raw_data{1,1}{1,j};
        ...
        for k = 1:num_points
            ...
            % get result:
            results_for_point = results_for_object;
