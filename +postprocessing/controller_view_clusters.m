function controller_view_clusters(job_settings, input_folder_name, output_folder_name)
    ...
    for i = 1:num_stacks
        ...
        for j = 1:num_slices
            ...
            for k = 1:num_objects_slice
                ...
                % add object to image:
                image_slice = utilities.add_result_to_image(job_settings.tool, image_slice, objects_slice(1,k).coordinates, objects_slice(1,k).object_clustered_color);
