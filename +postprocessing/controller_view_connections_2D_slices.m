function controller_view_connections_2D_slices(job_settings, input_folder_name, output_folder_name)
    ...
    % get objects:
    objects = load('objects_4_connected.mat');
    ...
    for i = 1:num_stacks
        ...
        for j = 1:num_slices
            ...
            for k = 1:num_objects_slice
                ...
                % add object to image:
                image_slice = utilities.add_result_to_image(job_settings.tool, image_slice, objects_slice(1,k).coordinates, objects_slice(1,k).object_connected_color);
